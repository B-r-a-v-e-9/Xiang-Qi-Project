...
public class Guardian extends Pieces {
    ...
    private int x;
    private int y;
    private final static String imagePathForBlack = "images/BlackTeam/Black_Guardian_1.png";
    private final static String imagePathForRed = "images/RedTeam/Red_Guarding_1.png";
    ...
    public Guardian(String name, boolean color, int x, int y) {
        this.name = name;
        this.color = color;
        this.x = x;
        this.y = y;
